	...
	while (b.get_age() <= 5 && q != EOF && b.get_death() != true) {
		...
		if(input == '6') {
	       ...
	       if(input == 'q') {	
			...
			if (b.get_sick() == false && b.get_hunger() <= 1 && b.get_happiness() <= 1) {
			...
			case '5': 
				...
				if (b.get_sick() == true) {
					...
					if (b.get_sick() == true &&  b.get_hunger() >= 1 && b.get_happiness() >= 1) {
						b.dec_happiness();
						b.inc_sick_count();
						dialogue(b.get_name().append( " still looks a little sick "));
					}
					...
					if (b.get_sick() == true &&  b.get_hunger() >= 1 && b.get_happiness() <= 1) {
						b.dec_happiness();
						b.inc_sick_count();
						dialogue(b.get_name().append( " still looks a little sick and not happy"));
					}
					...
					if (b.get_sick() == true && b.get_hunger() <= 1 && b.get_happiness() <= 1) {
						b.dec_happiness();
						b.inc_sick_count();
						dialogue(b.get_name().append( " still looks a little sick and kind of hungry"));
					}
					...
					if (b.get_sick() == true && b.get_hunger() <= 1 && b.get_happiness() >= 1) {
						b.dec_happiness();
						b.inc_sick_count();
						dialogue(b.get_name().append( " still looks sick but it looks hungry though"));
					}

					//If the tamagotchi is not sick, hungry, and not happy
					if (b.get_sick() == false && b.get_hunger() <= 1 && b.get_happiness() <= 1) {
						dialogue(b.get_name().append( " is feeling better. It looks hungry though, it also looks like it wants to play with you"));
					}

					//If the tamagotchi is not sick, hungry, and happy
					if (b.get_sick() == false && b.get_hunger() <= 1 && b.get_happiness() >= 1) {
						dialogue(b.get_name().append( " is feeling better looks hungry though"));
					}

					//If the tamagotchi is not sick, not hungry, and not happy
					if (b.get_sick() == false && b.get_hunger() >= 1 && b.get_happiness() <= 1) {
						dialogue(b.get_name().append( " is feeling better and looks like it wants to play with you"));
					}

					//If the tamagotchi is not sick, not hungry, and happy
					if (b.get_sick() == false && b.get_hunger() >= 1 && b.get_happiness() >= 1) {
						dialogue(b.get_name().append( " is feeling better and looks like its having a good time with you"));
					}
				}
